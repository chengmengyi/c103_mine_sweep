...
class MsP2CardMoveAnimatorWidget extends MsBaseStateful{
  @override
  State<StatefulWidget> createState() => MsP2CardMoveAnimatorWidgetState();
}

class MsP2CardMoveAnimatorWidgetState extends MsBaseStatefulState<MsP2CardMoveAnimatorWidget> with TickerProviderStateMixin{
  ...
  handleEventMessage(MsEventBean event) {
    switch(event.code){
      case MsP2EventCode.cardMoveAnimator:
