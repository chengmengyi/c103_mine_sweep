...
class MsP2Play70Con extends MsBaseCon{
  ...
  _delayShowList()async{
    for(var index=0;index<9;index++){
      ...
      switch(index){
        case 0:
          _startShowList(0, 0, 4);
          break;
        case 1:
          _startShowList(0, 4, 6);
          break;
        case 2:
          _startShowList(1, 0, 4);
          break;
        case 3:
          _startShowList(1, 4, 6);
          break;
        case 4:
          _startShowList(2, 0, 4);
          break;
        case 5:
          _startShowList(2, 4, 6);
          break;
        case 6:
          _startShowList(3, 0, 2);
          break;
        case 7:
          _startShowList(3, 2, 4);
          break;
        case 8:
          _startShowList(3, 4, 6);
          break;
      }
      update(["list"]);
