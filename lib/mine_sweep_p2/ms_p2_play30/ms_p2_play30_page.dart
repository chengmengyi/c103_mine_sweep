...
import 'package:c103_mine_sweep/mine_sweep_p2/ms_p2_play30/ms_p2_play30_con.dart';
...
class MsP2Play30Page extends MsBasePage<MsP2Play30Con>{
  @override
  MsP2Play30Con initMsCon() => MsP2Play30Con();
  ...
  _listWidget()=>GetBuilder<MsP2Play30Con>(
    id: "list",
    builder: (_){
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  _cardWidget(0,10).marginOnly(left: 27.w),
                  _cardWidget(0,11).marginOnly(left: 12.w),
                ],
              ),
              SizedBox(height: 16.h,),
              Row(
                ...
                children: [
                  _cardWidget(0,12),
                  _cardWidget(0,13).marginOnly(left: 27.w),
                ],
              ),
            ],
          ),
          Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  _cardWidget(1,1),
                  _cardWidget(1,2).marginOnly(left: 94.w),
                ],
              ),
              SizedBox(height: 16.h,),
              Row(
                ...
                children: [
                  _cardWidget(1,3),
                  _cardWidget(1,4).marginOnly(left: 94.w),
                ],
              ),
              SizedBox(height: 16.h,),
              _cardWidget(1,5),
