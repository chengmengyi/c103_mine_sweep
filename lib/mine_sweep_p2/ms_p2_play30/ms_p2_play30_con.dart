...
class MsP2Play30Con extends MsBaseCon{
    ...
    for(var index=0;index<8;index++){
      ...
      switch(index){
        case 0:
          ...
          break;
        case 1:
          _startShowList(0, 4, 8);
          break;
        case 2:
          _startShowList(0, 8, 12);
          break;
        case 3:
          _startShowList(0, 12, 14);
          break;
        case 4:
          _startShowList(1, 0, 1);
          break;
        case 5:
          _startShowList(1, 1, 3);
          break;
        case 6:
          _startShowList(1, 3, 5);
          break;
        case 7:
          _startShowList(1, 5, 6);
          break;
      }
      update(["list"]);
