...
import 'package:c103_mine_sweep/mine_sweep_p2/ms_p2_dialog/ms_p2_tomado/ms_p2_tornado_con.dart';
...
class MsP2TornadoDialog extends MsBaseDialog<MsP2TornadoCon>{
  Function() getWildCallback;
  MsP2TornadoDialog({required this.getWildCallback,});

  @override
  MsP2TornadoCon initMsCon() => MsP2TornadoCon();
