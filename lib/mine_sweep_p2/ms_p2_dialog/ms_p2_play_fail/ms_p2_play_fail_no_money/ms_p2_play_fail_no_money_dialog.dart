...
import 'package:c103_mine_sweep/mine_sweep_p2/ms_p2_dialog/ms_p2_play_fail/ms_p2_play_fail_no_money/ms_p2_play_fail_no_money_con.dart';
...
class MsP2PlayFailNoMoneyDialog extends MsBaseDialog<MsP2PlayFailNoMoneyCon>{
  Function() clickReplay;
  Function() clickHome;
  MsP2PlayFailNoMoneyDialog({
    required this.clickReplay,
    required this.clickHome,
  });
  @override
  MsP2PlayFailNoMoneyCon initMsCon() => MsP2PlayFailNoMoneyCon();
