...
class CashTaskCon extends MsBaseCon{
  ...
  clickBtn(MsP2CashTaskBean? bean){
    MsTbaUtils.instance.customEvent(eventName: MsCustomEventName.withdraw_task_pop_complete,params: {"withdraw_step":bean?.cashTask});
    MsRouterUtils.instance.back();
